      ...
      <div class="compare-table__head">
        ...
        ${pkgs.map(p => `
          <div class="compare-table__head-cell ${p.comingSoon ? 'is-coming-soon' : ''}">
            ...
            <span class="compare-table__pkg-price">${p.comingSoon ? 'Demnächst' : `ab ${priceCeil(p.price)} €<small>/ Mo</small>`}</span>
          </div>`).join('')}
      </div>`;
        ...
        ${pkgs.map(p => `
          <details class="compare-card ${p.comingSoon ? 'is-coming-soon' : ''}" ${p.badge === 'Empfehlung' ? 'open' : ''}>
            <summary class="compare-card__head">
              ...
              <span class="compare-card__pkg-price">${p.comingSoon ? 'Demnächst' : `ab ${priceCeil(p.price)} €<small> / Mo</small>`}</span>
