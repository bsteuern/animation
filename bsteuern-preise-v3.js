...
(function () {
  ...
  function syncDisc() {
    ...
    rcDiscPanel.style.display = detailsOpen ? 'block' : 'none';
    rcDiscPanel.style.padding = detailsOpen ? '0.125rem 2rem 1.625rem' : '0';
  }
  ...
  function render() {
    ...
    if (rcAdvisor) { rcAdvisor.style.display = 'flex'; rcAdvisor.innerHTML = advisorHtml(current); }
