...
(function () {
  ...
  /* rcDiscPanel initial verstecken — kein hidden-Attribut in Webflow gesetzt */
  ...
  function render() {
    ...
    if (p.flatPrice) {
      ...
      if (rcFounder) rcFounder.style.display = 'none';
      ...
      rcDetail.style.display = 'block';
      /* Inline-Style von Holding-Branch resetten damit CSS-Klasse .show greift */
      if (rcFounder) rcFounder.style.display = '';
    ...
    if (discSec) { discSec.hidden = false; discSec.style.display = 'block'; }
