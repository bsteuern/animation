...
(function () {
  ...
  function bindFloatingBar() {
    ...
    /* Sheet nur erstellen wenn noch nicht im DOM (z.B. via Webflow) */
    ...
    if (!sheet) {
      ...
      /* Webflow-Sheet: sicherstellen dass barSheetContent existiert */
      if (!document.getElementById('barSheetContent')) {
        const contentEl = document.createElement('div');
        contentEl.id = 'barSheetContent';
        sheet.appendChild(contentEl);
      }
      /* Handle-ID setzen für Close-Listener */
  ...
  function bindBarDetailsLink() {
    ...
    const open = () => {
      renderBarSheet(); /* Inhalt frisch rendern beim Öffnen */
