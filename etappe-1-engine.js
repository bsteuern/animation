/* ════════════════════════════════════════════════════════════
   ...
   ÄNDERUNGEN v31:
   - desc (Beschreibung) aus CMS-Feld data-package-desc
   - comingSoon erkennt "verfügbar" im Badge-Text (Switch-Workaround)
   - package-card-desc wird in Card gerendert
   ════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  function parsePackagesFromCMS() {
    ...
    nodes.forEach(node => {
      ...
      const pkg = {
        ...
        /* comingSoon: Switch-Felder können nicht gebunden werden —
           stattdessen erkennen wir "verfügbar" im Badge-Text */
