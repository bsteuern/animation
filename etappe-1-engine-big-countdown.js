...
(function () {
  ...
  function renderActionBanner() {
    ...
    /* Banner in der Summary-Card (Desktop + eingeklappte Mobile-Summary) */
    const body = document.querySelector('#calculatorSummary .summary-body')
              || document.querySelector('.summary-body');
    if (body && !body.querySelector('.action-banner')) {
